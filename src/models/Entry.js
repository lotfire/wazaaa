...
Object.assign(entrySchema.statics, {
  ...
  tags () {
    return this.aggregate(
      // L'aggrégation nous renvoie une liste d'objets ayant le tag en propriété `_id`,
      // mais on veut juste le tag.  Merci Underscore pour [`.pluck`](http://underscorejs.org/#pluck),
      // qui comme beaucoup d’autres nous vient [tout droit de Prototype.js](http://api.prototypejs.org/language/Enumerable/prototype/pluck/).
      { $project: { tags: 1 } },
      { $unwind: '$tags' },
